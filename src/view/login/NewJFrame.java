...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void verificaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_verificaActionPerformed
      JCheckBox[] box = {agua, suco};
      String[] lista_desejo = null;
            for (int i = 0; i < box.length; i++) {
                JOptionPane.showMessageDialog(null, box[i].getSelectedObjects());
                lista_desejo = (String[]) box[i].getSelectedObjects();
               
            }
            for (int i = 0; i < lista_desejo.length; i++) {
                System.out.println(lista_desejo[i]);
        }
